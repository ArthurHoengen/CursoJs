...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function geraNovoCpf() {
      var cpfSemDifito = this.rand();
      var digito1 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].criaDigito(cpfSemDifito);
      var digito2 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].criaDigito(cpfSemDifito + digito1);
      var novoCpf = cpfSemDifito + digito1 + digito2;
...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidaCPF, [{
    ...
    value: function valida() {
      ...
      var cpfValido = cpfParcial + digito1 + digito2;
    ...
    value: function criaDigito(cpfParcial) {
      ...
      var total = cpfArray.reduce(function (ac, valor, i) {

...
function gera() {
  return (0,_geradores__WEBPACK_IMPORTED_MODULE_0__["default"])(qtd.value, checkNumeros.checked, checkMaiusculas.checked, checkMinusculas.checked, checksimbolos.checked) || "Nada selecionado";
}
...
function geraSenha(qtd, numeros, maisuculas, minusculas, simbolos) {
  var senhaArray = [];
  qtd = Number(qtd);
  for (var i = 0; i < qtd; i++) {
